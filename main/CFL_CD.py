...
class CFL_CD():
    ...
    def Diffusion(self):
        ...
        for ite in range(self.iterations):
            ...
            if args.task == 'Class_IID':
                ...
                file_name = f'{args.dataset}/{args.task}_CFL_{args.dataset}_{args.framework}_NumClients_{args.client_number}_ClassIID.npy'
            ...
            CNN_file_name = f'{args.dataset}/model/CNN_{args.task}_CFL_{args.dataset}_{args.framework}.pth'
            Diffusion_file_name = f'{args.dataset}/model/Diffusion_{args.task}_CFL_{args.dataset}_{args.framework}.pth'
    ...
    def Domain_Diffusion(self):
        ...
        for ite in range(self.iterations):
            ...
            file_name = f'{args.dataset}/{args.task}_CFL_{args.dataset}_{args.framework}_DomainIID.npy'
...
if __name__ == '__main__':
    ...
    file_name = f'{args.dataset}/{args.task}_CFL_{args.dataset}_{args.framework}.npy'
